...
DEF2( "window_place_top", I18N_NOOP("Place left window to the top"), 0, 0, slotPlaceWindowTop() );
DEF2( "window_place_bottom", I18N_NOOP("Place left window to the bottom"), 0, 0, slotPlaceWindowBottom() );
