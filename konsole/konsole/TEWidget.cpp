...
static inline bool isLineChar(Q_UINT16 c) {
...
void TEWidget::extendSelection(QPoint pos) {
  ...
  if (word_selection_mode) {
    ...
    bool left_not_right = (here.y() < iPntSelCorr.y() || (here.y() == iPntSelCorr.y() && here.x() < iPntSelCorr.x()));
    bool old_left_not_right = (pntSelCorr.y() < iPntSelCorr.y() || (pntSelCorr.y() == iPntSelCorr.y() && pntSelCorr.x() < iPntSelCorr.x()));
